...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    categoryLabel: 'Site Institucional',
    tag: 'Site Institucional',
    image: '/images/marciliosegur.jpg',
    icon: '🔐',
...
export const TEAM = [
  {
    ...
    photo: '/images/vitor-guilherme.jpg',
    initials: 'VG',
...
// Cidades onde já entregamos projetos em produção.
// Coordenadas em % (x = da esquerda, y = do topo) relativas ao mapa estilizado do Brasil em ClientsMap.tsx.
// Para adicionar uma nova cidade conforme a empresa cresce, basta incluir mais um item aqui.
...
export const CLIENT_LOCATIONS: ClientLocation[] = [
  { city: 'Camaragibe', state: 'PE', x: 81, y: 37.5, isHQ: true },
  { city: 'Recife', state: 'PE', x: 83.5, y: 35.5 },
  { city: 'João Pessoa', state: 'PB', x: 85, y: 30 },
  { city: 'Manaus', state: 'AM', x: 22, y: 26 },
  { city: 'Belém', state: 'PA', x: 44, y: 12 },
  { city: 'São Luís', state: 'MA', x: 60, y: 14 },
  { city: 'Teresina', state: 'PI', x: 66, y: 24 },
  { city: 'Fortaleza', state: 'CE', x: 79, y: 19 },
  { city: 'Natal', state: 'RN', x: 87, y: 27 },
  { city: 'Maceió', state: 'AL', x: 80, y: 44 },
  { city: 'Aracaju', state: 'SE', x: 79, y: 47 },
  { city: 'Salvador', state: 'BA', x: 75, y: 53 },
  { city: 'Vitória', state: 'ES', x: 65, y: 69 },
  { city: 'Rio de Janeiro', state: 'RJ', x: 61, y: 77 },
  { city: 'São Paulo', state: 'SP', x: 53, y: 83 },
  { city: 'Belo Horizonte', state: 'MG', x: 57, y: 67 },
  { city: 'Brasília', state: 'DF', x: 51, y: 54 },
  { city: 'Goiânia', state: 'GO', x: 45, y: 58 },
  { city: 'Cuiabá', state: 'MT', x: 27, y: 54 },
  { city: 'Curitiba', state: 'PR', x: 47, y: 88 },
  { city: 'Porto Alegre', state: 'RS', x: 42, y: 90 },
];
