        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
          {TEAM.map((member, i) => (
            <Reveal key={member.id} delay={i * 0.1}>
              <div className="shadow-under flex h-full flex-col items-center gap-6 rounded-[24px] border border-brand-border bg-white p-8 text-center shadow-soft transition-all duration-300 hover:-translate-y-1 sm:flex-row sm:items-start sm:text-left">
                <div className="relative h-[90px] w-[90px] shrink-0">
                  <div className="absolute -inset-[3px] animate-spin-ring rounded-full bg-[conic-gradient(#0049ff,#0091c9,#0049ff)]" />
