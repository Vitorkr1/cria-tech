...
function ProjectCard({
  ...
  return (
    <motion.div
      ...
      className={`group relative overflow-hidden rounded-2xl border border-brand-border bg-white shadow-soft transition-all hover:-translate-y-1.5 hover:shadow-softLg ${className}`}
    >
      {project.isNew && (
            ...
            {filter === 'todos' && (
              <div className="flex gap-2">
                <button
                  ...
                  className="flex h-10 w-10 items-center justify-center rounded-full border border-brand-border bg-white text-brand-ink transition-all hover:border-brand-blue hover:text-brand-blue"
                >
                  <ChevronLeft size={18} />
                </button>
                <button
