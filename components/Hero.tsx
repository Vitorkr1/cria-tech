    ...
    <section id="inicio" className="relative pt-32 pb-16 sm:pt-40 sm:pb-20 px-4 sm:px-8 overflow-hidden">
      ...
      <div className="relative z-10 max-w-[880px] mx-auto text-center">
        <motion.h1
          ...
          animate="show"
          variants={fadeUp}
          className="font-sans font-extrabold text-[clamp(2.1rem,5.5vw,3.6rem)] leading-[1.04] tracking-[-0.055em] text-brand-ink mb-1.5"
        >
          O futuro da sua <br />empresa <span className="gradient-text reveal-underline">começa aqui.</span>
        </motion.h1>
        ...
        <motion.p
          ...
          animate="show"
          variants={fadeUp}
          className="text-brand-muted text-sm sm:text-base font-semibold leading-snug max-w-xl mx-auto mb-4"
        >
