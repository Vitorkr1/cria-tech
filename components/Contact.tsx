...
const CONTACT_LINKS = [
  ...
  },
  {
    label: 'WhatsApp',
    value: '(81) 8736-4575',
    href: 'https://wa.me/5581987364575?text=Ol%C3%A1%2C%20quero%20um%20or%C3%A7amento%20com%20a%20CriaTech',
    icon: <WhatsAppIcon />,
    iconBg: 'bg-[#25d366]/15 text-[#25d366]',
  },
  {
...
export default function Contact() {
  ...
  return (
    <section id="contato" className="relative overflow-hidden bg-transparent px-4 py-24 sm:px-8">
      ...
      <div className="relative mx-auto grid max-w-[1200px] grid-cols-1 gap-14 lg:grid-cols-2">
        <Reveal>
          ...
          <h2 className="mb-4 font-sans text-3xl font-extrabold tracking-tight leading-tight text-brand-ink sm:text-[2.4rem]">
          ...
          <a
            ...
            data-cursor-hover
            className="btn-shine mb-6 inline-flex items-center gap-2 rounded-xl bg-[#25d366] px-7 py-3.5 font-semibold text-white shadow-[0_10px_30px_-10px_rgba(37,211,102,0.5)] transition-all hover:-translate-y-0.5 hover:bg-[#1ebd59]"
          >
            <WhatsAppIcon size={18} /> Chamar no WhatsApp
          </a>
